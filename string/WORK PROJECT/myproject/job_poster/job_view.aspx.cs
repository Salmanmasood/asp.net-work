...
namespace myproject.job_poster
{
    public partial class job_view : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Label2.Text = re.scalarReturn("select comapany_details from company_name_tbl where company_id=" + Session["companyid"].ToString());
            ...
            lblcity.Text = re.scalarReturn("select location_city from company_location_tbl where location_login_id_fk=" + Session["jobid"].ToString());
            lblcountry.Text = re.scalarReturn("select location_country from company_location_tbl where location_login_id_fk=" + Session["jobid"].ToString());
