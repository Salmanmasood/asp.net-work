...
<body >
    ...
    <div id="wrapper" >
        ...
        <div class="col-md-12" style="height:auto;">
            ...
            <div class="col-md-4"style="height:auto;margin-top:100px;">
                 ...
                 <div class="form-group">
                      ...
                      <div class="input-group">
                         <h4>Country:</h4><p>
                             <asp:Button ID="Button1" runat="server" Text="Apply Now!" CssClass=" btn btn-success" OnClientClick="alertmsg()" OnClick="Button1_Click" />                  
        ...
        <asp:Label ID="Label3" onchange="alertmsg()" runat="server" Text=" "></asp:Label>
        </div>
    </form>
    ...
    <script>
        ...
        function alertmsg()
        {
            var c = document.getElementById("Label3").value;
            if (c !== " ")
            {
