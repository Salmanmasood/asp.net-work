...
namespace myproject.seeker_pages
{
    public partial class user_login : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string test = r.scalarReturn("select count(login_id) from login_information where login_email='" + TextBox1.Text + "'");
                ...
                if (dr.Read())
                {
                    ...
                    if (pasword_var == txtpassword.Text)
                    {
                       ...
                       q= ob.scalarReturn("SELECT personal_NAME FROM personal_info_login_information P INNER JOIN login_information L ON P.inpersonalinfo_login_id_fk=L.login_id WHERE L.login_email='"+TextBox1.Text+"'");
                        ...
                        Session["experience"] = ob.scalarReturn("select professional_experince from professional_info_login_information where inprofessional_login_id_fk=" + Session["c_img_id"]);
