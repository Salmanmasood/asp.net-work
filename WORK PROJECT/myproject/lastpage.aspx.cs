...
namespace myproject
{
    public partial class lastpage : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Session["scc_grades"] = ddlgrades_ssc.SelectedItem.ToString();
            Session["scc_percentage"] = ddlper_ssc.SelectedItem.ToString();

            Session["hsc_grades"] = DropDownList1.SelectedItem.ToString();
            Session["hsc_percentage"] = DropDownList2.SelectedItem.ToString();

            Session["grad_grades"] = DropDownList3.SelectedItem.ToString();
            Session["grad_percentage"] = DropDownList4.SelectedItem.ToString();

            Session["masters_grades"] = DropDownList5.SelectedItem.ToString();
        ...
        public bool loginmethod()
        {
            ...
            try
            {
                ...
                loginmethod.insert_loginmethod(Session["userid"].ToString(), Session["password"].ToString());
                //login info
                x = true;
            }
            catch (Exception)
        ...
        public bool complete_edu_method()
        {
            ...
            try
            {
                ...
                string[] ssc = new string[4];
                string[] hsc = new string[4];
                ...
                masters[3] = Session["fk_login_id"].ToString();
                



                insert_data ssc_obj = new insert_data();
                ssc_obj.insert_s_h_m_g("@ssc_Grades", "@ssc_percentage", "@ssc_institute", "@ssc_fk_id", "insert_scc_record", ssc);

                insert_data hsc_obj = new insert_data();
                hsc_obj.insert_s_h_m_g("@hsc_Grades", "@hsc_percentage", "@hsc_institute", "@hsc_fk_id", "insert_hsc_record", hsc);

                insert_data grad_obj = new insert_data();
                grad_obj.insert_s_h_m_g("@grad_Grades", "@grad_percentage", "@grad_institute", "@grad_fk_id", "insert_grad_record", grad);

                insert_data masters_obj = new insert_data();
                masters_obj.insert_s_h_m_g("@grad_Grades", "@grad_percentage", "@grad_institute", "@grad_fk_id", "insert_grad_record",masters);
        ...
        public string callallmethods(string j)
        {
            ...
            if (d == false)
            {
                s = "Error at complete edu method....";
