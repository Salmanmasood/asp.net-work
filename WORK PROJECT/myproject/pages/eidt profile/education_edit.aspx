...
<div class="col-lg-9" style="background-color:#dfe0e2;height:1000px;">
    ...
    <tr> <td>Institution Name:</td> <td> <asp:TextBox ID="TextBox1" class="form-control" runat="server"></asp:TextBox></td>  </tr>



    <tr> <td>Degree:</td> <td> <asp:TextBox ID="TextBox2" runat="server" class="form-control"></asp:TextBox></td>  </tr>
    ...
    <tr> <td>Percentage:</td> <td> <asp:TextBox ID="TextBox3" runat="server" class="form-control"></asp:TextBox></td>  </tr>





    <tr> <td></td> <td><asp:Button ID="Button1" runat="server" Text="Insert" CssClass="form-control btn-info" /> </td>  </tr>
