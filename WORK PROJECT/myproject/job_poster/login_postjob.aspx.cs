        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            protected void bt1_Click(object sender, EventArgs e)
            {
                ...
                if (x == 1)
                {
                    ...
                    HttpCookie cookie = new HttpCookie("posterid");
                    Returnclass rc = new Returnclass();
                    Session["company_fk_posterid"] = rc.scalarReturn("select login_id from job_poster_id where login_email='" + TextBox1.Text + "' and login_password='" + txtpassword.Text + "'");
                    cookie["poster_id"] = rc.scalarReturn("select login_id from job_poster_id where login_email='"+TextBox1.Text+"' and login_password='"+txtpassword.Text+"'");
