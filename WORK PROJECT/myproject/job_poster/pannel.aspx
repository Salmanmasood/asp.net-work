      ...
      <label>Comapny Name</label>
                ...
                <div class="col-lg-12 ">
                    ...
                    <div class="col-lg-8 ">
                         ...
                         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:jobportaldb %>" SelectCommand="SELECT [company_name] FROM [company_name_tbl] WHERE ([company_fk_posterid] = @company_fk_posterid)">
                             <SelectParameters>
                                 <asp:SessionParameter Name="company_fk_posterid" SessionField="company_fk_posterid" Type="Int32" />
                             </SelectParameters>
                         </asp:SqlDataSource>
